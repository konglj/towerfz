...
public class WXInfo {
	...
	public static final String appid = "wx95b9c38fbdd131dc";
	
	public static final String secret = "e0247cea20bef9c241f70cf0d59010ae";
	
	public static final String topcolor="#FF0000";

	public static final String taskTemplateid="nyawfApDFR5nEi4765_CZqreif3mRivIEYIeqBrB0e4";
	public static final String taskUrl="%s/manager/get_service.html?adminselectstate=1&msgorderid=%d&openid=%s";
	
	public static final String moneyTemplateid="N4vJZMkzgdnxosgTW1j8VIvLLP6GzCAhB_XlRyeHYUo";
	public static final String moneyUrl="%s/money/mymoney.html?openid=%s";
	
	public static final String sh_order_successTemplateid="3-j3KhIucory-5KjQIiINkEAD0izxr--K4cQGpEFQrc";
	public static final String sh_order_successUrl="%s/order/order_list.html?msgorderid=%d&openid=%s";
	
	public static final String dk_successTemplateid="_RqoPC3hI1ssOaFC-n7eN_CZvlxb35gxK0jHs1lE4qo";
	public static final String dk_successUrl="%s/money/tx_record_list.html?openid=%s&txid=%s";
	
	public static final String send_tw_noticeTemplateid="nyawfApDFR5nEi4765_CZqreif3mRivIEYIeqBrB0e4";
	public static final String send_tw_noticeUrl="%s/twnotice/noticeinfo.html?noticeid=%d";
	
	public static final String dk_apply_successTemplateid="nyawfApDFR5nEi4765_CZqreif3mRivIEYIeqBrB0e4";
	public static final String dk_apply_successUrl="%s/money/mymoney.html?openid=%s";
	
	public static final String sh_order_yqTemplateid="nyawfApDFR5nEi4765_CZqreif3mRivIEYIeqBrB0e4";
	public static final String sh_order_yqUrl="%s/order/order_list.html?msgorderid=%d&openid=%s";
	
	//验证通过
	public static final String user_verity_successTemplateid="nyawfApDFR5nEi4765_CZqreif3mRivIEYIeqBrB0e4";
	...
	//++++++++++++++++目标建站审核通知内容++++++++++++++++++++++++++
		...
		public static final String order_post_undo_user="福州铁塔";
		...
		public static final String user_verity_user="福州铁塔";
